class Admin::StudyInvolvementsController < Admin::AdminController
  ...
  private
    ...
    def study_involvment_params
      params.require(:study_involvement).permit(:participant_id, :study_id, :notes, :start_date, :end_date, :warning_date, :state, :state_date, :extended_release, study_involvement_status_attributes: [:name, :date, :state, :_destroy, :id])
    end
end
