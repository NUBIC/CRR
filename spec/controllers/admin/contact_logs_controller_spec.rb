...
RSpec.describe Admin::ContactLogsController, type: :controller do
  before(:each) do
    ...
    @contact_log    = FactoryBot.create(:contact_log)
  ...
  describe 'unauthorized access' do
    ['researcher?'].each do |role|
      ...
      describe 'POST create' do
        it 'redirects to dashboard' do
          post :create, params: { contact_log: @valid_params }
          expect(response).to redirect_to(controller: :users, action: :dashboard)
        end
      ...
      describe 'GET edit' do
        it 'redirects to dashboard' do
          get :edit, params: { id: @contact_log.id }
          expect(response).to redirect_to(controller: :users, action: :dashboard)
        end
      ...
      describe 'POST update' do
        it 'redirects to dashboard' do
          post :update, params: { id: @contact_log.id, contact_log: @valid_params }
          expect(response).to redirect_to(controller: :users, action: :dashboard)
        end
      ...
      describe 'POST destroy' do
        it 'redirects to dashboard' do
          post :destroy, params: { id: @contact_log.id }
          expect(response).to redirect_to(controller: :users, action: :dashboard)
        end
  ...
  describe 'authorized access' do
    ['data_manager?', 'admin?'].each do |role|
      ...
      describe 'POST create' do
        describe 'with valid parameters' do
          ...
          it 'redirects to participant page' do
            post :create, params: { id: @contact_log.id, contact_log: @valid_params }
        ...
        describe 'with invalid parameters' do
          it 'does not create a contact_log' do
            expect {
              post :create, params: { contact_log: @invalid_params }
      ...
      describe 'POST update' do
        ...
        describe 'with invalid parameters' do
          before(:each) do
            post :update, params: { id: @contact_log.id, contact_log: @invalid_params }
          end
