    ...
    ['researcher?'].each do |role|
      ...
      describe 'GET index' do
        it 'redirects to dashboard' do
          get :index, xhr: true, params: { participant_id: @participant.id }
      ...
      describe 'GET new' do
        it 'redirects to dashboard' do
          get :new, xhr: true, params: { participant_id: @participant.id }
          expect(response).to redirect_to(controller: :users, action: :dashboard)
        end
      ...
      describe 'POST create' do
        it 'redirects to dashboard' do
          post :create, params: { response_set: @params }
          expect(response).to redirect_to(controller: :users, action: :dashboard)
        end
      ...
      describe 'POST update' do
        it 'redirects to dashboard' do
          post :update, params: { id: @response_set.id, response_set: @params }
          expect(response).to redirect_to(controller: :users, action: :dashboard)
        end
      ...
      describe 'POST destroy' do
        it 'redirects to dashboard' do
          post :destroy, params: { id: @response_set.id }
          expect(response).to redirect_to(controller: :users, action: :dashboard)
        end
      ...
      describe 'POST create' do
        describe 'with valid parameters' do
          ...
          it 'redirects to participant page if response_set is public' do
            ...
            post :create, params: { id: @response_set.id, response_set: @params }
      ...
      describe 'POST update' do
        describe 'with valid parameters' do
          ...
          it 'renders edit page in js format' do
            post :update, xhr: true, params: { id: @response_set.id, response_set: @params }
            expect(response).to render_template('edit')
          end
          ...
          describe 'with incomplete response_set' do
            ...
            describe 'if finish parameter is specified' do
              it 'redirects to dashboard in html format' do
                post :update, params: { id: @response_set.id, response_set: @params, button: 'finish' }
