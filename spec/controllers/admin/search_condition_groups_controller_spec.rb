...
RSpec.describe Admin::SearchConditionGroupsController, type: :controller do
  before(:each) do
    login_user
    ...
    ['data_manager?', 'researcher?', 'admin?'].each do |role|
      ...
      describe 'POST create' do
        it 'redirects to dashboard' do
          post :create, params: { search_condition_group: @valid_params }
      ...
      describe 'POST update' do
        it 'redirects to dashboard' do
          post :update, params: { id: @search_condition_group.id, search_condition_group: @valid_params }
          expect(response).to redirect_to(controller: :users, action: :dashboard)
        end
      ...
      describe 'POST destroy' do
        it 'redirects to dashboard' do
          post :destroy, params: { id: @search_condition_group.id }
          expect(response).to redirect_to(controller: :users, action: :dashboard)
        end
  ...
  describe 'authorized access' do
    ['admin?', 'data_manager?', 'researcher?'].each do |role|
      ...
      describe 'POST create' do
        ...
        describe 'with invalid parameters' do
          it 'does not create a participant' do
            expect {
              post :create, params: { search_condition_group: @invalid_params }
      ...
      describe 'POST update' do
        ...
        describe 'with invalid parameters' do
          before(:each) do
            post :update, params: { id: @search_condition_group.id, search_condition_group: @invalid_params }
          end
